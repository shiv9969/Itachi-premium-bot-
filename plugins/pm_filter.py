...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b><a href='https://t.me/ThappyHour'>Request Hare - t.me/ThappyHour\nRequest Hare - t.me/ThappyHour\nRequest Hare - t.me/ThappyHour</a></b>")
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("📥 𝗦𝗲𝗻𝗱 𝗔𝗹𝗹 𝗙𝗶𝗹𝗲𝘀 📥", url=f"https://telegram.me/{temp.U_NAME}?start=files_{file.file_id}"),
    ])
    try:
