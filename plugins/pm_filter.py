        ...
        await query.edit_message_reply_markup(
            ...
            [
                [
                    ...
                    InlineKeyboardButton('🇮🇳 ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ 🇮🇳', url='https://t.me/BoB_Files1')
                ]
            ]
        ))
    else:
...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Type & Get - t.me/REQUESTING_MOVIES_SERIES_GROUPS</b>")
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            InlineKeyboardButton("⛥ ʀᴇᴍᴏᴠᴇ ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ ⛥", url="https://t.me/TheHappyHourBOT?start=TheHappyHour")
                    ...
                    InlineKeyboardButton('🍁 Buy Premium 🍁', url='https://t.me/Bullmovieess_autofilter_bot?start=TheHappyHour')  
                    ]
                                ]
                            )
                        )
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
            InputMediaPhoto("https://graph.org/file/792201104b4f148346696.jpg")
        ) 
        await query.message.edit_text(
