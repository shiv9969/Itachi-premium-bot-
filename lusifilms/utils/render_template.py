...
from lusifilms.utils.custom_dl import TGCustomYield
...
async def render_page(message_id):
    ...
    if mime_type.lower() in video_formats:
        async with aiofiles.open('lusifilms/template/req.html') as r:
        ...
        async with aiofiles.open('lusifilms/template/dl.html') as r:
